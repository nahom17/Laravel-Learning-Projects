                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $order }}">
                            ...
                            <td data-th="incl_vat" class="text-center">
                                @if($item->discount_price)
                                 &euro;{{ number_format(($item->discount_price * $item->quantity)*$item->product->vat/100+$item->discount_price*$item->quantity+ $item->product->vat/100+ ($productarribute->accessory->discount_price * $item->quantity)*$productarribute->accessory->vat/100+$productarribute->accessory->discount_price * $item->quantity+$productarribute->accessory->vat/100, 2, ',', '.') }}
                                @else
