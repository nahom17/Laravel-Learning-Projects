...
<div class="container">
    ...
    <a href="{{ route('admin.products.accessories.index',$product->id) }}" class="nav-link active" id="nav-profile-tab">Configuratie</a>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.products.accessories.store', $product)}}" method="POST" enctype="multipart/form-data">
                    @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @enderror
                    ...
                    <div class="mb-3 d-flex float-end">
                        ...
                        <button type="submit" class="btn btn-primary">Configrator toevoegen</button>
                    </div>
            </form>
            </div>
            </div>
