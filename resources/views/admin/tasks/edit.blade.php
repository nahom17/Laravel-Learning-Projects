    ...
    <div class="row flex-nowrap">
        ...
        <div class="row align-items-center py-3">
            ...
            @enderror
                    ...
                    <select class="form-select @error('user_id') is-invalid @else @enderror" name="user_id" id="select2" value="{{$task->user_id}}"  data-placeholder="zoke een gebruiker">
                        @php
            ...
            @enderror
                    ...
                    <select class="form-select @error('project_id') is-invalid @else @enderror" name="project_id" id="select1">
